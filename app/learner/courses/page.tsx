              ...
              <NCard className="p-4 sticky top-32">
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-base transition-all border-2 ${!selectedCategory
                  ...
                  {categories.map((category) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-base transition-all border-2 ${selectedCategory === category
                          ? "bg-main/10 text-foreground font-heading border-border"
                          : "text-foreground/70 hover:bg-main/5 border-transparent font-base"
                        }`}
                    >
