...
import { useEducatorSidebar } from "@/components/sidebar-context"
...
export function EducatorLayout({ children }: EducatorLayoutProps) {
  const { collapsed: sidebarCollapsed, setCollapsed: setSidebarCollapsed, mobileOpen: sidebarOpen, setMobileOpen: setSidebarOpen, isHydrated } = useEducatorSidebar()
