...
export function FullScreenCalendar({ data, onNewEvent }: FullScreenCalendarProps) {
      ...
      <div className="flex flex-col space-y-4 p-4 md:flex-row md:items-center md:justify-between md:space-y-0 lg:flex-none">
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row md:gap-6">
          ...
          {onNewEvent && (
            <Button 
              onClick={onNewEvent} 
              className="w-full gap-2 md:w-auto transition-all hover:scale-105 hover:shadow-lg active:scale-95 border-2 border-border shadow-shadow"
            >
